...
#Create levels for Weekdayys 1-7?
#Convert into into ordered factor
...
################################################
#Replicating the same Data Preparation Process
#VALIDATION
################################################
...
#sapply(validation$daypart,class)
...
########################################################################################################
#PREAPARING TEST DATA FOR MODELLING
########################################################################################################
...
#sapply(test_data$daypart,class)
